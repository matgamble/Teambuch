"""
WhatsApp-Icon fuer die "Ankündigungen"-Gruppe der Community "Die
Verrueckten": ein Orka-Symbol (aus site/orka-symbol.png, Original
schwarz-weiss) auf warmem Verlaufshintergrund, mit gebogenem Schriftzug
"Ankündigungen" (Georgia italic, wie das "Teambuch"-Wortlogo),
"Kita Reischlestraße" unten und duennem Gold-Ring als Rahmen. Gleiches
Layout wie build.py ("Die Verrueckten") / build_bilder.py ("Bilder").

Aufruf: python3 build_ankuendigungen.py -> erzeugt icon-ankuendigungen.png
...
paste_y = int(SIZE * 0.56) - target_h // 2
...
# arc lettering "Ankündigungen", curved above the whale
arctext = Image.open(BASE / "arctext-ankuendigungen.png").convert("RGBA")
at_w = int(SIZE * 0.92)
...
final.save(OUT_DIR / "icon-ankuendigungen.png")
